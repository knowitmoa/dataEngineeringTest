...
if responsePlanet.status_code == 200:
    ...
    print(f"Failed to retrieve planets data. Status code: {responsePlanet.status_code}")
...
if responsePeople.status_code == 200:
    ...
    print(f"Failed to retrieve persons data. Status code: {responsePeople.status_code}")
...
if responseStarships.status_code == 200:
    ...
    print(f"Failed to retrieve starships data. Status code: {responseStarships.status_code}")
